...
public class MenuGeneratorTest {
    ...
    @Test
    public void testGenerate() throws JAXBException, MenuGenerationException {
        ...
        final MenuConfig menuConfig = unmarshaller.unmarshall(new File(pathname));

        final MenuGenerator generator = new MenuGenerator();
        JMenu jMenu = generator.generateMenu(menuConfig);
    ...
    @Test
    public void testSortByName() throws JAXBException, MenuGenerationException {
        ...
        final MenuGenerator generator = new MenuGenerator();
        JMenu jMenu = generator.generateMenu(menuConfig, configuration);
        testSimpleOrder(jMenu);
    }


    @Test
    public void testSubmenusToTop() throws JAXBException, MenuGenerationException {
        InputStream stream = this.getClass().getResourceAsStream("/configuration-test-menu.xml");
        final MenuConfigUnmarshaller unmarshaller = new MenuConfigUnmarshaller();
        final MenuConfig menuConfig = unmarshaller.unmarshall(stream);
        final MenuGroupType menuGroupB = (MenuGroupType) menuConfig.getMenu().getItems().getMenuGroupOrMenuItem().get(1);
    ...
    @Test
    public void testSubmenusToBottom() throws JAXBException, MenuGenerationException {
        InputStream stream = this.getClass().getResourceAsStream("/configuration-test-menu.xml");
        final MenuConfigUnmarshaller unmarshaller = new MenuConfigUnmarshaller();
        final MenuConfig menuConfig = unmarshaller.unmarshall(stream);
        final MenuGroupType menuGroupB = (MenuGroupType) menuConfig.getMenu().getItems().getMenuGroupOrMenuItem().get(1);
    ...
    @Test
    public void testSortAndSubmenusToTop() throws JAXBException, MenuGenerationException {
        InputStream stream = this.getClass().getResourceAsStream("/configuration-test-menu.xml");
        final MenuConfigUnmarshaller unmarshaller = new MenuConfigUnmarshaller();
        final MenuConfig menuConfig = unmarshaller.unmarshall(stream);
        final MenuGroupType menuGroupB = (MenuGroupType) menuConfig.getMenu().getItems().getMenuGroupOrMenuItem().get(1);
